...
recording_time = 10  # in seconds [s]
...
power_spectrum_1_dBm = 10 * np.log10(power_spectrum_1 / 1e-3)
power_spectrum_2_dBm = 10 * np.log10(power_spectrum_2 / 1e-2)

freq_vector_pre = np.linspace(-sample_rate/2, sample_rate/2, total_samples+1)
freq_vector = freq_vector_pre[0:-1]

plt.plot(freq_vector, power_spectrum_1_dBm)
plt.plot(freq_vector, power_spectrum_2_dBm)
